...
description: Use in ASL Pilot for read-only Hugging Face Dataset Viewer API workflows, public dataset metadata/source review, subset and split inspection, filtering, parquet URL discovery, and size/statistics checks. Do not use for raw learner-video upload or unapproved source mutation.
---

# Hugging Face Dataset Viewer

ASL Pilot local policy: keep Dataset Viewer usage read-only unless the active
prompt and user explicitly authorize a specific upload or source change.
